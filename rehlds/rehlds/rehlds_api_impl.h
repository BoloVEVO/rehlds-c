...
//PreProcessPacketEX
typedef IHookChainImpl<bool, uint8*, unsigned int, const netadr_t&, unsigned int> CRehldsHook_PreprocessPacketEX;
typedef IHookChainRegistryImpl<bool, uint8*, unsigned int, const netadr_t&, unsigned int> CRehldsHookRegistry_PreprocessPacketEX;
...
public:
	...
	CRehldsHookRegistry_PreprocessPacketEX m_PreprocessPacketEX;
...
public:
	...
	EXT_FUNC virtual IRehldsHookRegistry_PreprocessPacketEX* PreprocessPacketEX();
};
